// function play() {
//    var audio = new Audio('./audio/DCOHC_MeiWah_0016_LT_MIX.mp3');
//        audio.play();
// }
...
var config = {
    ...
    chapters: [
        {
            id: 'The First Restaurant in DC',
            title: 'Chinese Boy Born in Vietnam',
            image: './images/fathers_store_Tra_Vinh.jpg',
            audio: './audio/DCOHC_MeiWah_0015_LT_MIX.mp3',
	    description: 'Larry La was born in Vietnam in the 1950s to Chinese parents who left China during the Chinese Civil War. As a teenager, his father emigrated to Vietnam and settled down in South Vietnam near the Mekong delta. His five children spoke Chinese at home and used Vietnamese at school.',
            location: {
