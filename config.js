var config = {
    ...
    chapters: [
        ...
        {
            id: 'boat4554',
            title: 'Boat People: Fleeing South Vietnam after the War',
            image: './images/Slide_06_Boat.png',
            audio: './audio/DCOHC_Meiwah_Slide_06.mp3',
            description: 'Following the end of the Vietnam War in 1975, Larry’s family fled Vietnam by boat and arrived at a refugee camp on the island of Borneo in Malaysia. The family stayed at the refugee camp for 15 months.',
            transcript:'<i>In the late 1970s, a lot of small boat of Vietnamese people, fled out of Vietnam. They go to Thailand, Malaysia or Indonesia or the Philippines. So we just decided to go, and so we left Vietnam at that time in 1978 October. And we were on the ocean. It\'s really it\'s a big ocean with a small boat of 292 people in it. So we were so lucky we could survive the storms, survived the wave, survived the pirates. We didn\'t run into any pirates. At that time, the Thai pirates, they really operate very hard because they know a lot of people get out of Vietnam. They have jewelry, they have money, they have everything. So they rowed up there. So we are lucky we didn\'t have all these thing, and we survived after 9 days and 8 nights then we got to East Malaysia. Called the Borneo Island. They called Kuching in Sarawak.</i>',
            location: {
        ...
        description: 'When Larry’s family arrived in Erwin in the late 1970s, it was the only family of color living in the area. ',
        ...
        },
	{
        ...
        },
        {
            ...
            description: '',
            transcript: 'So we got that space, and then later on, it\'s opened up, and everything is just different now. The neighborhood is just totally changed. And so, we were lucky. We get in there on time, and then after 20 years, the lease was up, and the rent was up, and I said, okay, let\'s get out and find something else. You know, we don\'t want to pay too much rent, because the rent, in this restaurant business, rent, if you have the rent under 10% of your revenue, you\'re pretty comfortable, you\'re okay. But if the rent gets to 15 or more, then you\'ll be kind of caught. So, and you can\'t keep increasing the price to the customer. So, I said, well, we\'ll just find another location. So, that\'s why we closed that restaurant three and a half months ago. I really miss it. I worked there for 20 years, and as I said, from the beginning, I\'m there almost everyday, seven days a week, and sleep on the chair. But I always tell people that I was a refugee. I slept in the floor in the jungle, in the refugee camp. So, everything else is good for me. Yeah, mentality, again. Your mentality is very important. Always think about it.',
            location: {
        ...
        },
        {
            ...
            description: '<span class="quote">In the United States, it doesn\'t matter how small a Chinese restaurant is or how big it is, you have to have General Tso\'s chicken. That\'s one of the main things....You can\'t find it in China. Like the fortune cookie, you don\'t have it in China... But people love it.”</span>',
